...
|---|---|---|
| 대상 | `app/**` `actions/**` `services/**` `lib/**` `prisma/**` `tests/**` | `docs/**` `tasks/**` `AGENTS.md` `AGENTS.md` `README.md` `.Codex/**` `.cursor/**` `scripts/**` |
...
**스킬을 고쳤다면** 원본은 `.Codex/skills/` 다. 고친 뒤 `bash scripts/sync-skills.sh` 로
