...
- `[NEW]` `app/consent/page.tsx` — 법정대리인 동의 (Clean)
- `[NEW]` `app/consent/consent.fixture.ts` — fixture

> fixture 첫 줄에 `// PROTO-DATA: TASK-202` 마커를 넣는다. 구현 완료 시 파일을 삭제하고 `grep -rn "PROTO-DATA: TASK-202"` 가 0건임을 확인한다.
