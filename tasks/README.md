...
> 🗺️ **병렬 실행 그림부터 보려면 →** [`00_PARALLEL_GANTT.md`](00_PARALLEL_GANTT.md)  
> 간소화 의존성 다이어그램 · 병렬 간트 차트 · 동시 실행 보드 · 독립 실행 가능 태스크 · 착수 신호등

> 🧭 **실행 순서·파일 소유권·게이트 판정 상세는 총괄 문서를 따르십시오 →** [`docs/00_PROJECT_DAG_ROADMAP.md`](../docs/00_PROJECT_DAG_ROADMAP.md)  
> 본 디렉토리는 *개별 태스크를 어떻게 구현하는가*를, 총괄 문서는 *누가·언제·어떤 순서로 실행하는가*를 정의합니다.
