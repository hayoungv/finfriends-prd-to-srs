...
import type { OutfitId } from "@/components/child/WardrobeAvatar";
...
// SRS §6.6 AC1 기준 2종·4벌로 그린다. PRD ADR-007 은 5종·8벌이라 어긋나 있으며
// 실제 종수·벌수와 에셋 형식(2D 벡터 vs 사전 제작 3D)은 TASK-214 착수 전 별도 해소한다 (grill T14).
...
export const wearing: OutfitId = "raincoat";
