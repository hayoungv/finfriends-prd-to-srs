...
| 단계 | 산출물 문서 | 버전 | 주요 내용 |
|:---:|---|:---:|---|
| **00. 총괄 실행 계획** | [`docs/00_PROJECT_DAG_ROADMAP.md`](docs/00_PROJECT_DAG_ROADMAP.md) | `v2.0` | **개발 총괄 실행 계획서 (Execution Master Plan) — 실행 SSOT**<br>• 태스크 본문 30건 전수 대조 기반 DAG · 7개 위상 웨이브<br>• CPM 임계경로 5.5 MD 및 4트랙 병렬 Gantt (총 20.5 MD)<br>• 파일 소유권 맵(충돌 0건), 교차 트랙 계약 8건, 순환 의존 해소 규약<br>• Alpha/Beta/General 릴리즈 게이트 통과 프로토콜 및 리스크 레지스터 |
